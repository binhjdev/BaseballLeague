...
import dev.binhjdev.androidbasketballleague.databinding.StandingsHeaderBinding
import dev.binhjdev.androidbasketballleague.databinding.StandingsTeamItemBinding
...
class StandingsAdapter :
    ...
    fun addHeadersAndBuildStandings(uiTeamStandings: List<UITeamStanding>) = CoroutineScope(
        ...
        val items = uiTeamStandings
            ...
            .map { (division, teams) ->
                listOf(StandingsListItem.Header(division)) + teams.map { team ->
                    StandingsListItem.TeamItem(
                        team
                    )
                }
            }.flatten()
